...
/* to override these locally (with remote xul), create a server/skin/custom.js file containing lines like
    ...
    urls['AUDIO_good'] = '/xul/grpl_2_2/server/skin/media/custom/good.wav';
...
const CLIENT_VERSION = 'server';
const CLIENT_STAMP   = 'grpl_2_2';
...
var urls = {
    ...
    'AUDIO_good' : '/xul/grpl_2_2/server/skin/media/audio/bonus.wav',
    'AUDIO_bad' : '/xul/grpl_2_2/server/skin/media/audio/question.wav',
    'AUDIO_horrible' : '/xul/grpl_2_2/server/skin/media/audio/redalert.wav',
    'AUDIO_circ_good' : '/xul/grpl_2_2/server/skin/media/audio/toggled.wav',
    'AUDIO_circ_bad' : '/xul/grpl_2_2/server/skin/media/audio/question.wav',
    'AUDIO_event_ASSET_COPY_NOT_FOUND' : '/xul/grpl_2_2/server/skin/media/audio/redalert.wav',

    'AUTHORITY_MANAGE' : '/eg/cat/authority/list',
    'MANAGE_MULTI_HOME_ITEMS' : '/xul/grpl_2_2/server/cat/manage_multi_home_items.xul',
    'XUL_AUTH_SIMPLE' : '/xul/grpl_2_2/server/main/simple_auth.xul',
    'XUL_BIB_BRIEF' : '/xul/grpl_2_2/server/cat/bib_brief.xul',
    'XUL_BIB_BRIEF_VERTICAL' : '/xul/grpl_2_2/server/cat/bib_brief_vertical.xul',
    'XUL_BROWSER' : 'chrome://open_ils_staff_client/content/util/browser.xul',
    'XUL_CHECKIN' : '/xul/grpl_2_2/server/circ/checkin.xul',
    'XUL_BACKDATE' : '/xul/grpl_2_2/server/circ/backdate_post_checkin.xul',
    'XUL_RENEW' : '/xul/grpl_2_2/server/circ/renew.xul',
    'XUL_CHECKOUT' : '/xul/grpl_2_2/server/circ/checkout.xul',
    'XUL_CIRC_BRIEF' : '/xul/grpl_2_2/server/circ/circ_brief.xul',
    'XUL_CIRC_SUMMARY' : '/xul/grpl_2_2/server/circ/circ_summary.xul',
    'XUL_COPY_BUCKETS_QUICK' : '/xul/grpl_2_2/server/cat/copy_buckets_quick.xul',
    'XUL_COPY_BUCKETS' : '/xul/grpl_2_2/server/cat/copy_buckets.xul',
    'XUL_COPY_DETAILS' : '/xul/grpl_2_2/server/circ/copy_details.xul',
    'XUL_COPY_EDITOR' : '/xul/grpl_2_2/server/cat/copy_editor.xul',
    'XUL_COPY_LOCATION_EDIT' : '/xul/grpl_2_2/server/admin/copy_locations.xhtml',
    'XUL_COPY_NOTES' : '/xul/grpl_2_2/server/cat/copy_notes.xul',
    'XUL_COPY_STATUS' : '/xul/grpl_2_2/server/circ/copy_status.xul',
    'XUL_COPY_SUMMARY' : '/xul/grpl_2_2/server/cat/copy_summary.xul',
    'XUL_COPY_VOLUME_BROWSE' : '/xul/grpl_2_2/server/cat/copy_browser.xul',
    'XUL_DEBUG_CONSOLE' : 'chrome://global/content/console.xul',
    'XUL_DEBUG_FIELDMAPPER' : '/xul/grpl_2_2/server/util/fm_view.xul',
    'XUL_DEBUG_FILTER_CONSOLE' : '/xul/grpl_2_2/server/util/filter_console.xul',
    'XUL_DEBUG_SHELL' : '/xul/grpl_2_2/server/util/shell.html',
    'XUL_DEBUG_XULEDITOR' : '/xul/grpl_2_2/server/util/xuledit.xul',
    'XUL_DO_NOT_AUTO_ATTEMPT_PRINT_SETTING' : '/xul/grpl_2_2/server/admin/do_not_auto_attempt_print_setting.xul',
    'XUL_FANCY_PROMPT' : '/xul/grpl_2_2/server/util/fancy_prompt.xul',
    'XUL_HOLD_CAPTURE' : '/xul/grpl_2_2/server/circ/hold_capture.xul',
    /*'XUL_HOLD_PULL_LIST' : '/xul/grpl_2_2/server/admin/hold_pull_list.xhtml',*/
    'XUL_HOLD_PULL_LIST' : '/xul/grpl_2_2/server/patron/holds.xul',
    'XUL_HOLDS_BROWSER' : '/xul/grpl_2_2/server/patron/holds.xul',
    'XUL_HOLD_DETAILS' : '/xul/grpl_2_2/server/patron/hold_details.xul',
    'XUL_HOLD_CANCEL' : '/xul/grpl_2_2/server/patron/hold_cancel.xul',
    'XUL_HOLD_PLACEMENT' : '/xul/grpl_2_2/server/patron/place_hold.xul',
    'XUL_IN_HOUSE_USE' : '/xul/grpl_2_2/server/circ/in_house_use.xul',
    'XUL_LIST_CLIPBOARD' : '/xul/grpl_2_2/server/util/list_clipboard.xul',
    'XUL_LOCAL_ADMIN' : '/xul/grpl_2_2/server/admin/index.xhtml',
    'XUL_LOGIN_DATA' : '/xul/grpl_2_2/server/main/data.xul', 
    'XUL_MARC_NEW' : '/xul/grpl_2_2/server/cat/marc_new.xul',
    'XUL_MARC_EDIT' : '/xul/grpl_2_2/server/cat/marcedit.xul',
    'XUL_MARC_VIEW' : '/xul/grpl_2_2/server/cat/marc_view.xul',
    'XUL_MENU_FRAME' : 'chrome://open_ils_staff_client/content/main/menu_frame.xul',
    'XUL_NON_CAT_LABEL_EDIT' : '/xul/grpl_2_2/server/admin/non_cat_types.xhtml',
    'XUL_OFFLINE_UPLOAD_XACTS' : '/xul/grpl_2_2/server/admin/upload_xacts.xhtml',
    'XUL_OFFLINE_MANAGE_XACTS' : '/xul/grpl_2_2/server/admin/offline_manage_xacts.xul',
    'XUL_OFFLINE_MANAGE_XACTS_CGI' : '/cgi-bin/offline/offline.pl',
    'XUL_OFFLINE_GENERATE_WIDGETS' : '/xul/grpl_2_2/server/main/gen_offline_widgets.xul',
    'XUL_REMOTE_OPAC_WRAPPER' : '/xul/grpl_2_2/server/cat/opac.xul',
    'XUL_OPAC_WRAPPER' : 'chrome://open_ils_staff_client/content/cat/opac.xul',
    'XUL_PATRON_BARCODE_ENTRY' : '/xul/grpl_2_2/server/patron/barcode_entry.xul',
    'XUL_PATRON_BILLS' : '/xul/grpl_2_2/server/patron/bill2.xul',
    'XUL_PATRON_BILL_CC_INFO' : '/xul/grpl_2_2/server/patron/bill_cc_info.xul',
    'XUL_PATRON_BILL_CHECK_INFO' : '/xul/grpl_2_2/server/patron/bill_check_info.xul',
    'XUL_PATRON_BILL_DETAILS' : '/xul/grpl_2_2/server/patron/bill_details.xul',
    'XUL_PATRON_BILL_HISTORY' : '/xul/grpl_2_2/server/patron/bill_history.xul',
    'XUL_PATRON_BILL_WIZARD' : '/xul/grpl_2_2/server/patron/bill_wizard.xul',
    'XUL_PATRON_DISPLAY' : '/xul/grpl_2_2/server/patron/display.xul',
    'XUL_PATRON_HORIZ_DISPLAY' : '/xul/grpl_2_2/server/patron/display_horiz.xul',
    'XUL_PATRON_EDIT' : '/eg/actor/user/register',
    'XUL_PATRONS_DUE_REFUNDS' : '/xul/grpl_2_2/server/admin/patrons_due_refunds.xul',
    'XUL_USER_PERM_EDITOR' : '/xul/grpl_2_2/server/patron/user_edit.xhtml',
    'XUL_PATRON_HOLDS' : '/xul/grpl_2_2/server/patron/holds.xul',
    'XUL_PATRON_INFO_NOTES' : '/xul/grpl_2_2/server/patron/info_notes.xul',
    'XUL_PATRON_INFO_STAT_CATS' : '/xul/grpl_2_2/server/patron/info_stat_cats.xul',
    'XUL_PATRON_INFO_SURVEYS' : '/xul/grpl_2_2/server/patron/info_surveys.xul',
    'XUL_PATRON_INFO_GROUP' : '/xul/grpl_2_2/server/patron/info_group.xul',
    'XUL_PATRON_ITEMS' : '/xul/grpl_2_2/server/patron/items.xul',
    'XUL_PATRON_SEARCH_FORM' : '/xul/grpl_2_2/server/patron/search_form.xul',
    'XUL_PATRON_HORIZONTAL_SEARCH_FORM' : '/xul/grpl_2_2/server/patron/search_form_horiz.xul',
    'XUL_PATRON_SEARCH_RESULT' : '/xul/grpl_2_2/server/patron/search_result.xul',
    'XUL_PATRON_SUMMARY' : '/xul/grpl_2_2/server/patron/summary.xul',
    'XUL_PRE_CAT' : '/xul/grpl_2_2/server/circ/pre_cat_fields.xul',
    'XUL_PRINT_LIST_TEMPLATE_EDITOR' : '/xul/grpl_2_2/server/circ/print_list_template_editor.xul',
    'XUL_RECORD_BUCKETS' : '/xul/grpl_2_2/server/cat/record_buckets.xul',
    'XUL_RECORD_BUCKETS_QUICK' : '/xul/grpl_2_2/server/cat/record_buckets_quick.xul',
    'XUL_REMOTE_BROWSER' : '/xul/grpl_2_2/server/util/rbrowser.xul',
    'XUL_SERIAL_ITEM_EDITOR' : '/xul/grpl_2_2/server/serial/sitem_editor.xul',
    'XUL_SERIAL_NOTES' : '/xul/grpl_2_2/server/serial/notes.xul',
    'XUL_SERIAL_SELECT_AOU' : '/xul/grpl_2_2/server/serial/select_aou.xul',
    'XUL_SERIAL_SELECT_UNIT' : '/xul/grpl_2_2/server/serial/select_unit.xul',
    'XUL_SERIAL_SERCTRL_MAIN' : '/xul/grpl_2_2/server/serial/serctrl_main.xul',
    'XUL_SPINE_LABEL' : '/xul/grpl_2_2/server/cat/spine_labels.xul',
    'XUL_STAGED_PATRONS' : '/xul/grpl_2_2/server/patron/staged.xul',
    'XUL_STANDALONE' : 'chrome://open_ils_staff_client/content/circ/offline.xul',
    'XUL_STANDING_PENALTIES' : '/xul/grpl_2_2/server/patron/standing_penalties.xul',
    'XUL_NEW_STANDING_PENALTY' : '/xul/grpl_2_2/server/patron/new_standing_penalty.xul',
    'XUL_EDIT_STANDING_PENALTY' : '/xul/grpl_2_2/server/patron/edit_standing_penalty.xul',
    'XUL_SCAN_ITEM_AS_MISSING_PIECES' : '/xul/grpl_2_2/server/circ/missing_pieces.xul',
    'XUL_STAT_CAT_EDIT' : '/xul/grpl_2_2/server/admin/stat_cat_editor.xhtml',
    'XUL_SURVEY_WIZARD' : 'chrome://open_ils_staff_client/content/admin/survey_wizard.xul',
    'XUL_TIMESTAMP_DIALOG' : '/xul/grpl_2_2/server/util/timestamp.xul',
    'XUL_TOOLBAR_CONFIG' : '/xul/grpl_2_2/server/admin/toolbar.xul',
    'XUL_TRIGGER_EVENTS' : '/xul/grpl_2_2/server/patron/trigger_events.xul',
    'XUL_USER_BUCKETS' : '/xul/grpl_2_2/server/patron/user_buckets.xul',
    'XUL_VERIFY_CREDENTIALS' : '/xul/grpl_2_2/server/main/verify_credentials.xul',
    'XUL_VOLUME_BUCKETS' : '/xul/grpl_2_2/server/cat/volume_buckets.xul',
    'XUL_VOLUME_COPY_CREATOR' : '/xul/grpl_2_2/server/cat/volume_copy_editor.xul',
    'XUL_VOLUME_COPY_CREATOR_HORIZONTAL' : '/xul/grpl_2_2/server/cat/volume_copy_editor_horiz.xul',
    'XUL_VOLUME_COPY_CREATOR_ORIGINAL' : '/xul/grpl_2_2/server/cat/volume_copy_creator.xul',
    'XUL_VOLUME_EDITOR' : '/xul/grpl_2_2/server/cat/volume_editor.xul',
    'XUL_WORK_LOG' : '/xul/grpl_2_2/server/admin/work_log.xul',
    'XUL_WORKSTATION_INFO' : '/xul/grpl_2_2/server/main/ws_info.xul',
    'XUL_Z3950_IMPORT' : '/xul/grpl_2_2/server/cat/z3950.xul',
    'TEST_HTML' : '/xul/grpl_2_2/server/main/test.html',
    'TEST_XUL' : '/xul/grpl_2_2/server/main/test.xul',
    'CONIFY' : '/conify/' + LOCALE + '/global',
    'CONIFY_MANAGE_PARTS' : '/eg/conify/global/biblio/monograph_part',
    'EG_WEB_BASE' : '/eg',
    'XUL_LOCAL_ADMIN_BASE' : '/xul/grpl_2_2/server/admin',
    'XUL_REPORTS' : '/reports/oils_rpt.xhtml',
    'EG_ACQ_PO_VIEW' : '/eg/acq/po/view',
    'EG_ACQ_USER_REQUESTS' : '/eg/acq/picklist/user_request',
    'XUL_SERIAL_BATCH_RECEIVE': '/xul/grpl_2_2/server/serial/batch_receive.xul'
}
